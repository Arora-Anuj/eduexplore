      ...
      <div className=" flex flex-col justify-center items-center gap-[30px] mt-[44px] lg:mt-[66px]">
        ...
        <div className=" mx-auto flex items-center justify-center flex-col lg:flex-row  lg:justify-evenly mt-[20px] lg:mt-[50px] lg:w-full lg:gap-x-[140px] ">
          <div className=" flex flex-col items-center justify-center gap-y-[31px] lg:gap-y-[81px]  ">
            <Image src={join1} alt="join1" className=" w-[90%] md:w-[60%] lg:hidden " />
            <Image src={join4} alt="join1" className=" w-[90%] md:w-[60%] lg:hidden " />

            <Image src={join5} alt="join1" className=" lg:w-[472px] lg:h-[120px] lg:inline hidden " />
            <Image src={join6} alt="join1" className=" lg:w-[472px] lg:h-[120px] lg:inline hidden " />
          </div>
          <div className="mt-[31px] lg:mt-0 flex flex-col items-center justify-center gap-y-[31px] lg:gap-y-[81px] ">
            <Image src={join3} alt="join1" className=" w-[90%] md:w-[60%] lg:hidden " />
            <Image src={join2} alt="join1" className=" w-[90%] md:w-[60%] lg:hidden " />

            <Image src={join7} alt="join1" className=" lg:w-[472px] lg:h-[120px] lg:inline hidden " />
            <Image src={join8} alt="join1" className=" lg:w-[472px] lg:h-[120px] lg:inline hidden " />
          </div>
        </div>
      </div>
    </div>
