  ...
  return (
    <div className="flex flex-col items-center justify-center text-center pt-[20px] bg-[#EEEFFC] w-full pb-[64px]">
      ...
      <div className=" w-8/12 mt-[11px] leading-normal">
        <p className="text-[#1b1d30] text-[26px] font-semibold leading-[24.5px] tracking-[-0.408px]">
          Join Our
          <span className="text-[#d63970] text-[26px] font-semibold leading-[24.5px] tracking-[-0.408px]">
      ...
      <p className="tracking-[-0.408px] w-full text-start px-[28px] mt-[27px] text-[#1b1d30] text-[15px] font-semibold font-['Caros'] leading-[18px]">Click here to join now:</p>
    </div>
  );
}
