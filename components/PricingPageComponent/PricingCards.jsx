  ...
  return (
    ...
    >
      <div className="bg-[#EEEFFC] w-[332px] h-[190px]  lg:w-[491px] lg:h-[598px] rounded-xl px-[21px] lg:px-[47px]  ">
          ...
          <div className="rightside w-[60%] lg:w-full  flex items-start justify-center py-5">
            <ul className="space-y-2 text-[10px] font-light  w-[90%] lg:w-full lg:text-xl lg:leading-normal">
              <li className="flex items-center gap-2 text-start">
                {" "}
                <Image src={tick} alt="tick" width={13} className="lg:w-[20px] lg:h-[20px] " /> Feedback from experts
              </li>
              <li className="flex items-center gap-2 text-start">
                {" "}
                <Image src={tick} alt="tick" width={13} className="lg:w-[20px] lg:h-[20px] " /> Digital Certificate
              </li>
              <li className="flex items-center gap-2 text-start">
        ...
        {/* <button className=" w-full  rounded-lg bg-[#5259AA] p-2 text-white ">
          Participate Now
        </button> */}
        <button
      ...
      <div className=" relative bg-[#EEEFFC] w-[332px] h-[190px]  lg:w-[491px] lg:h-[598px] rounded-xl px-[21px] lg:px-[47px]  ">
        ...
        <div className=" flex justify-evenly lg:flex-col mt-2">
          ...
          <ul className="space-y-2 text-[10px] font-light  w-[90%] lg:w-full lg:text-xl lg:leading-normal">
              ...
              <li className="flex items-center gap-2 font-bold">
                {" "}
                <Image src={tick} alt="tick" width={13} className="lg:w-[20px] lg:h-[20px] " /> Physical Certificate
              </li>
              <li className="flex items-center gap-2">
                <Image src={tick} alt="tick" width={13} className="lg:w-[20px] lg:h-[20px] " /> Medal for Winners
              </li>
              <li className="flex items-center gap-2">
                <Image src={tick} alt="tick" width={13} className="lg:w-[20px] lg:h-[20px] " />
