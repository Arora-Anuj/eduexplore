    ...
    <>
      <div className=" flex flex-col min-w-full items-center justify-center my-10">
        ...
        <div className={ ` ${caros.className} text-sm sm:text-base flex flex-col items-center justify-center gap-y-2 font-medium text-black my-10`}>
          <div className=" text-center flex items-center justify-center  w-[97vw] md:w-[70vw]  gap-2">
          ...
          <div className="text-center flex items-center justify-center w-[97vw] md:hidden gap-2 ">
            <div className="  bg-[#FFC56F] px-2 py-1 rounded-lg flex-auto">
              Build Confidence
            </div>
            <div className="  bg-[#00AFAA] px-2 py-1 rounded-lg flex-auto">
