  ...
  return (
    <div className=" min-w-full md:min-w-[45%] flex md:flex-col items-center justify-center p-3">
      <div className="px-[37px] my-[32px] flex flex-col items-center justify-center">
        <p
          className={`${publicSans.className} leading-[28px] tracking-[-0.41px] text-[#d63970] text-center text-[26px] font-medium`}
        >
          How to Register
          ...
          <Image src={reg1} alt="reg1" className="w-[301px] mt-[41px] md:hidden " />
      </div>
