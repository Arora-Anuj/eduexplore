...
export default function HowToRegister() {
  return (
    <div className=" min-w-full flex items-center justify-center p-3">
      <div className=" my-10">
        <p className="text-[#d63970] text-center text-[26px] font-medium font-['Publica Sans'] leading-normal">
          How to Register
        ...
        <div className="flex mt-3  items-center justify-center text-white">
          <div className=" w-[20%] sm:w-[100px] flex flex-col items-center justify-center text-center">
            <p className=" font-semibold">Click on 'Register Now'</p>
          </div>
