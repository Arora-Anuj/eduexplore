...
export default function PerksOfJoining() {
  return (
    <div className=" bg-[#EEEFFC] w-screen ">
      <div className=" flex flex-col items-center justify-center mt-10">
        ...
        <div className="my-5 flex flex-wrap items-center justify-evenly w-full gap-y-7">
          <div className=" bg-[#1B1D30] w-10/12 md:w-[200px] md:h-[250px] items-center justify-center flex flex-col gap-2 p-4 rounded-2xl text-center">
